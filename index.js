...
export default class ModalSelector extends React.Component {
    ...
    onChange = (item) => {
        ...
        /* this doesn't seem to play nice, the setState below doesn't propagate to the onDismiss state (changeItem) is undefined in the onDismiss function (leaving for reference)
